...
export default function Projects() {
  ...
  const hasMoreProjects = projects ? visibleCount < projects.length : false;
  const remainingCount = projects ? projects.length - visibleCount : 0;
  ...
  return (
    <>
      <SEO
        titleEn="Projects"
        titleTr="Projeler"
        descriptionEn="Things I've built and worked on."
        descriptionTr="Oluşturduğum ve üzerinde çalıştığım şeyler."
        url="/projects"
      />
